    ...
    <div className="flex flex-col h-full justify-between">
      <form onSubmit={handleCreateRoom} className="w-full flex flex-col gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5 flex flex-col">
            ...
            <input
              ...
              className="w-full h-11 bg-zinc-900 border border-dashed border-zinc-700 text-white px-3 text-sm rounded-none focus:outline-none focus:border-emerald-500 transition-colors"
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5 flex flex-col">
            ...
            <input
              ...
              className="w-full h-11 bg-zinc-900 border border-dashed border-zinc-700 text-white px-3 text-sm rounded-none focus:outline-none focus:border-emerald-500 transition-colors tracking-[0.2em]"
            />
          </div>

          <div className="space-y-1.5 flex flex-col">
            <label className="text-[10px] font-bold text-transparent uppercase tracking-widest ml-1 select-none pointer-events-none">
              Spacer
            </label>
            <label
              className={`flex items-center justify-between w-full h-11 px-3 border border-dashed cursor-pointer transition-colors rounded-none ${
                requiresApproval
        ...
        <button
          ...
          className="relative w-full h-13 flex items-center justify-center bg-white text-black font-bold text-sm md:text-base rounded-none px-4 mt-2 overflow-hidden transition-all hover:bg-zinc-200 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 group shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] border border-dashed border-zinc-300"
        >
          {isCreating ? (
            <>
              <svg
